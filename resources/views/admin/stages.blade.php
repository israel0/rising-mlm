...
<div class="user-content">
    <div class="container">
        <div class="stage-packages">
            <h5>Select a Package:</h5>
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                    <?php echo $package->name ?> Package <span class="fa fa-caret-down"></span>
                </button>
            ...
            <?php foreach ($stages as $stage) { ?>
                <div class="col-sm-6 col-lg-3">
                    <div class="user-box <?php echo $stage->stage_id == $stage_id ? "bg_active" : "" ?>">
                        <div class="inner">
                            <h3><?php
                                echo  App\Models\User::getTotalUserinStageandPackage($package->id, $stage->id); // $usercount;
                                ?></h3>
                            <p><?php echo $stage->rank ?> USERS</p>
                        </div>
                        <a class="small-box-footer" href="<?php echo url("admin/stages/$package->id/$stage->stage_id") ?>">
                            View Users
                        </a>
                    </div>
                </div>

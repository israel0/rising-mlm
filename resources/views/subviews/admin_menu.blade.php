...
<div class="sidebar">
    <div class="main-title">
        ...
        <img class="top-logo" src="<?php echo url("images/logo_vertical.png") ?>">
    </div>
    <ul class="nav nav-pills nav-stacked">
        <li class="<?php echo ($adminMenu == 1) ? "active" : ""; ?>"><a href="<?php echo url("admin"); ?>"><span class="fa fa-dashboard"></span> Users</a></li>
        <li class="<?php echo ($adminMenu == 2) ? "active" : ""; ?>"><a href="<?php echo route('admin_stages', ['package' => 1, 'stage_id' => 0]) ?>"><span class="fa fa-users"></span> Packages & Stages</a></li>

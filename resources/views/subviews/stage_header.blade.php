        ...
        <div class="">
            ...
            <div id="navbar-collapse" class="navbar-menu collapse navbar-collapse hidden-xs">
                <ul class="nav navbar-nav navbar-left hidden-xs">
                    ...
                    <li class="dropdown">
                        <button class="btn btn-primary dropdown-toggle"  data-toggle="dropdown">CHANGE PACKAGE</button>
                        <ul class="dropdown-menu">
                            @foreach($packages as $package)
                                <li><a href="<?php echo route('admin_stages', ['package' => $package->id, 'stage_id' => $stage_id]) ?>"> {{ $package->name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
                </ul>

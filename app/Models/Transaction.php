...
class Transaction extends Model
{
    ...
    public static $REFERRAL_WALLET = 5;
    ...
    public static function createDebitTransaction($wallet, $amount, $userName)
    {
        ...
        switch ($wallet) {
            ...
            case Transaction::$STAGE_BONUS_WALLET:
                ...
                $transaction->comment = "A total of $amount NGN has been debited from your Incentive Bonus wallet.";
                break;
    ...
    public static function createCreditTransaction($wallet, $amount, $userName, $purpose = null)
    {
        ...
        switch ($wallet) {
            ...
            case Transaction::$STAGE_BONUS_WALLET:
                ...
                $transaction->comment = "A total of $amount NGN has been credited into your Incentive Bonus wallet $purposeString";
                break;
            case Transaction::$GROUP_BONUS_WALLET:

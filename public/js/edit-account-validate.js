...
function validateSponsorName() {
    var sponsorName = $("#edit-account-form").find("#sponsorNameField").val();
    if (isEmpty(sponsorName)) {
        addSponsorError("#edit-account-form", "#sponsorNameField", "Please Fill out this field");
        return false;
    } else if (!isLetterOrNumber(sponsorName)) {
        addSponsorError("#edit-account-form", "#sponsorNameField", "Invalid Sponsor Name. No special characters and spaces allowed.");
        return false;
    } else if (!validateLength(sponsorName, 4, 20)) {
        addSponsorError("#edit-account-form", "#sponsorNameField", "Sponsor Name should contain 4 - 20 characters without spaces");
        return false;
    } else {
        return true;
    }
